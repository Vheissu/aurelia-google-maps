System.register(['aurelia-framework', 'aurelia-event-aggregator', './configure'], function (_export) {
    'use strict';

    var bindable, inject, customElement, TaskQueue, EventAggregator, Configure, GoogleMaps;
    ...
    return {
        ...
        execute: function () {
            GoogleMaps = (function () {
                ...
                GoogleMaps = inject(Element, EventAggregator, TaskQueue, Configure)(GoogleMaps) || GoogleMaps;
